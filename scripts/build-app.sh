...
cp "$project_dir/AppResources/Bavbav-v2.icns" "$staged_app_dir/Contents/Resources/Bavbav-v2.icns"
cp "$project_dir/AppResources/BavbavIcon-v2.png" "$staged_app_dir/Contents/Resources/BavbavIcon-v2.png"
